      ...
      <form class="d-flex" role="search">
        ...
        <div class="content">
                <div class="maincontent" >
                  <h1>Let's Join<br><span>The</span> <br>Revolution</h1>
                  <p class="par">"Support MyAnthem's Mission and help us to make a difference in the world.
                  <br>With your help, we can provide training programs & critical resources,  
                  <br> and support to those in need of their passion & creativity.</p>
                  <button class="cn"><a href="https://docs.google.com/forms/d/e/1FAIpQLSckDN1kZOh5NE0nocrtWcBpnymVif8bxqkKMmADnlRt8NJ7aA/viewform">JOIN US</a></button>
                </div>
...
<section >
<div class="login">
  <!--<img src="{{ asset('css/bg1.jpg') }}" alt="Card Image">-->
  <div class="form">                    
...
<section>
  <div>
  <img src="{{ asset('css/imp.png') }}" alt="Card Image">  </div>
</section>
  <!--<section class="about" id="about">-->
  <!--  <div class="about-left-side">-->
  <!--    <h1>Our Impact</h1>-->
  <!--    <h3>-->
  <!--      We've worked on improving the lives of <br />-->
  <!--      over 25,000 young people through direct <br />-->
  <!--      practice.-->
  <!--    </h3>-->
  <!--    <br>-->
  <!--    <p>-->
  <!--      Young people from different backgrounds have a huge <br />-->
  <!--      impact on us and all our activities. They highlight those <br />-->
  <!--      parts of the society that are broken, so we can help them in <br />-->
  <!--      all possible ways to regain hope and flourish in life.-->
  <!--    </p>-->
        <!-- <img src="{{ asset('css/impact.jpg') }}" alt="Card Image"> -->
  <!--  </div>-->
  <!--  <div class="about-right-side">-->
  <!--  <img src="{{ asset('css/logo1.jpg') }}" alt="Card Image" style="height: 400px"> -->
  <!--  </div>-->
  <!--</section>-->
   <section>
  <div>
  <img src="{{ asset('css/what.png') }}" alt="Card Image">  </div>
</section>
  <br>
   <section>
  <div>
  <img src="{{ asset('css/ex.png') }}" alt="Card Image">  </div>
</section>
