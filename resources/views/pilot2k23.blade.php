  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="/pilot2k23">Gallery</a>
        </li>
        <li class="nav-item">
...
<div class="card-container">
            ...
            <img src="{{ asset('css/pilot1.jpg') }}" alt="Card Image">
            </div>
            <div class="card">
            <img src="{{ asset('css/pilot2.jpg') }}" alt="Card Image">
            </div>
            <div class="card">
            <img src="{{ asset('css/pilot3.jpg') }}" alt="Card Image">
            </div>
            <div class="card">
            <img src="{{ asset('css/pilot4.jpg') }}" alt="Card Image">
            </div>
            <div class="card">
            <img src="{{ asset('css/pilot5.jpg') }}" alt="Card Image">
            </div>
            <div class="card">
            <img src="{{ asset('css/pilot6.jpg') }}" alt="Card Image">
            </div>
            <div class="card">
            <img src="{{ asset('css/pilot7.jpg') }}" alt="Card Image">
            </div>
            <div class="card">
            <img src="{{ asset('css/pilot8.jpg') }}" alt="Card Image">
            </div>
            <div class="card">
            <img src="{{ asset('css/pilot9.jpg') }}" alt="Card Image">
            </div>
            <div class="card">
            <img src="{{ asset('css/pilot10.jpg') }}" alt="Card Image">
            </div>
            <div class="card">
            <img src="{{ asset('css/pilot11.jpg') }}" alt="Card Image">
            </div>
            <div class="card">
            <img src="{{ asset('css/pilot12.jpg') }}" alt="Card Image">
            </div>
        </div>
    </main>
    <!-- Footer -->
