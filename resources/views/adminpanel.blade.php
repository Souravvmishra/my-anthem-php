...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>MyAnthems | AdminPanel</title>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="/">MyAnthems</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/pilot2k23">Events'23</a>
        </li>
        <li class="nav-item">
...
<body>
<header>
        <h1>Welcome to My Anthems AdminPanel</h1>
    </header>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <a href="#">Progress Graphs</a>
            <a href="#">Category Distribution</a>
    ...
    Logout
        ...
        <div class="content">
            <div class="card">
                ...
                <p>View the latest updates and activities related to your contributions.</p>
            </div>
            <div class="card">
                <h2>Your Campaigns</h2>
                <p>Manage and track the campaigns you support.</p>
            </div>
            <div class="card">
                <h2>Messages</h2>
                <p>Check your messages from the organization.</p>
            </div>
        </div>
    </div>
    <!-- Footer Section -->
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" class="text-white">DreamForm</a>
          </p>
      </div>
        <!-- Grid column -->
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <hr
              ...
              <br>
              <p>
              <a href="#!" class="text-white">Pilot2k23</a>
          </p>
          <p>
