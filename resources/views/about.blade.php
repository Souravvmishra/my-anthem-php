...
<link href="https://fonts.googleapis.com/css2?family=Rubik+Mono+One&display=swap" rel="stylesheet">
  ...
  <div class="container-fluid">
    ...
    <section>
  <div>
  <img src="{{ asset('css/Untitled.png') }}" alt="Card Image">  </div>
</section>
<section>
  <div>
  <img src="{{ asset('css/quotez.png') }}" alt="Card Image">  </div>
</section>
<section>
  <div>
  <img src="{{ asset('css/vision.png') }}" alt="Card Image">  </div>
</section>
<section>
  <div>
  <img src="{{ asset('css/gfbdfsv.png') }}" alt="Card Image">  </div>
</section>
<section>
  <div>
  <img src="{{ asset('css/vds.png') }}" alt="Card Image">  </div>
</section>
<section>
  <div>
  <img src="{{ asset('css/dcsaxz.png') }}" alt="Card Image">  </div>
</section>
    ...
    <style>
        ...
        #dreamcatchers {
            background-image: url(/image-alignment-300x200.webp);
...
<body>
   <h1 style="font-size: 40px; text-align: center; font-family: initial">Our Team</h1>
<div class="card-container">
<div class="card" id="dreamcatchers">
            <img src="{{ asset('css/team1.jpeg') }}" alt="Card Image">
            <h1>Anurag Dwivedi</h1>
            <p>Founder & CEO</p>
            </div>
            <div class="card">
            <img src="{{ asset('css/2.png') }}" alt="Card Image">
            <h1>Chandrabhan Singh</h1>
            <p>Resource Management</p>
            </div>
            <div class="card">
            <img src="{{ asset('css/team17.png') }}" alt="Card Image">
            <h1>Saif Ali</h1>
            <p>Research & Media</p>
            </div>
            <div class="card">
            <img src="{{ asset('css/4.png') }}" alt="Card Image">
            <h1>Akshay Singh Solanki</h1>
            <p>Partnerships</p>
            </div>
            <div class="card">
            <img src="{{ asset('css/team3.jpg') }}" alt="Card Image">
            <h1>Sandeep Kumar</h1>
            <p>Sr.Operations</p>
            </div>
            <div class="card">
            <img src="{{ asset('css/5.png') }}" alt="Card Image">
            <h1>Pritesh Keshri</h1>
            <p>AI & Technology</p>
            </div>
            <div class="card">
            <img src="{{ asset('css/logan.png') }}" alt="Card Image">
            <h1>Aryan Kumar</h1>
            <p>General Operations</p>
            </div>
            <div class="card">
            <img src="{{ asset('css/1.png') }}" alt="Card Image">
            <h1>Shafquat Khan</h1>
            <p>Project Management</p>
            </div>
            <div class="card">
            <img src="{{ asset('css/anoopa.png') }}" alt="Card Image">
            <h1>Anoopa Dwivedi</h1>
            <p>HR & Compliance</p>
            </div>
            <div class="card">
            <img src="{{ asset('css/8.png') }}" alt="Card Image">
            <h1>Priti Pandey</h1>
            <p>Account & Finance</p>          
          </div>
            <div class="card">
            <img src="{{ asset('css/team13.jpg') }}" alt="Card Image">
            <h1>Rupali Tyagi</h1>
            <p>Public Relations</p>
            </div>
            <div class="card">
            <img src="{{ asset('css/7.png') }}" alt="Card Image">
            <h1>Akanksha Tripathi</h1>
            <p>Girls Health & Education</p>
            </div>
            <div class="card">
            <img src="{{ asset('css/6.png') }}" alt="Card Image">
            <h1>Utkarsh Singh</h1>
            <p>Programs Management</p>
            </div>
            <div class="card">
            <img src="{{ asset('css/3.png') }}" alt="Card Image">
            <h1>Nitesh Kesharwani</h1>
            <p>Students Welfare Management</p>
            </div>
            <div class="card">
            <img src="{{ asset('css/shalini.png') }}" alt="Card Image">
            <h1>Shalini Srivastava</h1>
