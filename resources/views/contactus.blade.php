...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>MyAnthems | ContactUs</title>
    ...
    <div class="content">
      <div class="left-side">
        <div class="address details">
          ...
          <div class="text-one">Singh Bhavan, Sangam Vihar Colony,</div>
          <div class="text-two">Lodhan - Chandmari,
          Varanasi, Uttar Pradesh, 221003.</div>
        </div>
        <div class="phone details">
          <i class="fas fa-phone-alt"></i>
          <div class="topic">Phone</div>
          <div class="text-one">+91 9555501690</div>
          <div class="text-two">+91 9602704181</div>
        </div>
        <div class="email details">
          <i class="fas fa-envelope"></i>
          <div class="topic">Email</div>
          <div class="text-one">anthem.anurag@gmail.com</div>
          <!--<div class="text-two">info.codinglab@gmail.com</div>-->
        </div>
      </div>
      <div class="right-side">
        <div class="topic-text">Send us a message</div>
        <p>Have a suggestion, query, or a spark of an idea? We’re here to listen, collaborate, and bring your thoughts to life. Let’s connect and craft something remarkable together!</p>
      <form action="#">
        <div class="input-box">
