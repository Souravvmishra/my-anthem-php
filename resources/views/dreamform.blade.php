...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>MyAnthems | DreamForm</title>
   ...
   <a href="/"><img src="{{ asset('css/logo4.png') }}" alt="Card Image" style="height: 50px;"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="/dreamform">Dream Form</a>
        </li>
        <li class="nav-item">
      ...
      <form class="d-flex" role="search">
        ...
        <section class="sectioncontent">
            <form method="POST" action="{{ route('dreamform') }}" class="fillform">
    @csrf
    <div class="form-row">
    ...
    <div class="form-row">
        ...
        <div class="form-group">
            ...
            <input type="number" id="age" name="age" placeholder="Enter your age" required min="10" max="100">
        </div>
    </div>
    <div class="form-row">
        <div class="form-group">
            <label for="parents">Parents Name:</label>
            <input type="text" id="parents" name="parents" placeholder="Enter your parents name" required>
        </div>
        <div class="form-group">
    ...
    <div class="form-row">
        <div class="form-group full-width">
            <label for="passion">Your Passion:</label>
            <textarea id="passion" name="passion" placeholder="Describe your passion..." required></textarea>
        </div>
    </div>
    <div class="form-row">
        <div class="form-group full-width">
            <label for="portfolio">Upload Portfolio (optional):</label>
            <input type="file" id="portfolio" name="portfolio" accept="image/*,video/*">
        </div>
    </div>
        ...
        <section class="sectioncontent">
            ...
            <div class="scholarships">
                <div class="scholarship">
                    <h3>Art Excellence Scholarship's</h3>
                    <p>Eligibility: Ages 10-18</p>
                    <button onclick="alert('Applying for Art Excellence Scholarship')">Apply Now</button>
                </div>
                <div class="scholarship">
                    <h3>Sports Achiever’s Scholarship's</h3>
                    <p>Eligibility: National-level players</p>
                    <button onclick="alert('Applying for Sports Achiever’s Grant')">Apply Now</button>
                </div>
                <div class="scholarship">
                    <h3>Idol Campus Scholarship's</h3>
                    <p>Eligibility: No. Of Creative Students</p>
                    <button onclick="alert('Applying for Sports Achiever’s Grant')">Apply Now</button>
                </div>
            </div>
        </section>
